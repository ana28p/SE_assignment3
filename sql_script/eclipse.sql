...
select id, f_fileName, f_linesInserted, f_linesDeleted, f_revisionId, 0 from gm_eclipse.t_file where f_fileName not like '%/source/%' and f_fileName not like '%/src/%';
...
select result1.c1 as change_id, result1.review_time, result1.ecosystem_tenure, result1.changes, result1.review_tenure, result1.reviews, 
	...
	DATEDIFF(result1.updatedTime, result2.first_label) as blocking_tenure, result2.blocking_activity from
        ...
        from gm_eclipse.temp as f, gm_eclipse.t_revision as r, gm_eclipse.t_change as c, gm_eclipse.t_history as h 
		...
		FROM gm_eclipse.t_history as h, gm_eclipse.t_change as c
